...
require (
	...
	github.com/databus23/requestutil v0.0.0-20180216122111-92f82b6a311e
...
replace (
	github.com/ajeddeloh/go-json => github.com/coreos/go-json v0.0.0-20230530211827-23ecf4482aa9
	k8s.io/klog => github.com/simonpasquier/klog-gokit v0.3.1-0.20210409073344-020c8028ac9e
)
