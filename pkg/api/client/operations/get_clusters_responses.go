...
func (o *GetClustersOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/{account}/clusters][%d] getClustersOK  %+v", 200, o.Payload)
}
...
func (o *GetClustersOK) GetPayload() *models.GetClustersOKBody {
	return o.Payload
}
...
func (o *GetClustersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetClustersOKBody)
...
func (o *GetClustersDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/{account}/clusters][%d] GetClusters default  %+v", o._statusCode, o.Payload)
}
