...
// WithAccount adds the account to the get clusters params
func (o *GetClustersParams) WithAccount(account string) *GetClustersParams {
	o.SetAccount(account)
	return o
}

// SetAccount adds the account to the get clusters params
func (o *GetClustersParams) SetAccount(account string) {
	o.Account = account
}
