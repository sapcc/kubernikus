...
const (
	...
	// KlusterPhaseError captures enum value "Error"
	KlusterPhaseError KlusterPhase = "Error"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["Pending","Creating","Running","Terminating","Error"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
