...
func (m *GetClusterValuesOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetClusterValuesOKBody) UnmarshalBinary(b []byte) error {
	var res GetClusterValuesOKBody
