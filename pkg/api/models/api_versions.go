...
// ContextValidate validates this Api versions based on context it is used
func (m *APIVersions) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
