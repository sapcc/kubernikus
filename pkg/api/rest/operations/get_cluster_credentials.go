...
func (fn GetClusterCredentialsHandlerFunc) Handle(params GetClusterCredentialsParams, principal *models.Principal) middleware.Responder {
...
func NewGetClusterCredentials(ctx *middleware.Context, handler GetClusterCredentialsHandler) *GetClusterCredentials {
	return &GetClusterCredentials{Context: ctx, Handler: handler}
}
...
func (o *GetClusterCredentials) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetClusterCredentialsParams()
