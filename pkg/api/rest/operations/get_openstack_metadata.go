...
func (fn GetOpenstackMetadataHandlerFunc) Handle(params GetOpenstackMetadataParams, principal *models.Principal) middleware.Responder {
...
func NewGetOpenstackMetadata(ctx *middleware.Context, handler GetOpenstackMetadataHandler) *GetOpenstackMetadata {
	return &GetOpenstackMetadata{Context: ctx, Handler: handler}
}
...
func (o *GetOpenstackMetadata) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetOpenstackMetadataParams()
