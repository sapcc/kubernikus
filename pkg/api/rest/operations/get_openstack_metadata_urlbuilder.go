...
func (o *GetOpenstackMetadataURL) WithBasePath(bp string) *GetOpenstackMetadataURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetOpenstackMetadataURL) Build() (*url.URL, error) {
	...
	var _path = "/api/v1/openstack/metadata"
...
func (o *GetOpenstackMetadataURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetOpenstackMetadataURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetOpenstackMetadataURL")
	}
