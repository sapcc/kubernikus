...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1.SchemeGroupVersion.WithResource("sapccloudproviderconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kubernikus().V1().SAPCCloudProviderConfigs().Informer()}, nil
