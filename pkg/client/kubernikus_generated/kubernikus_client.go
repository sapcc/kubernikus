...
// NewHTTPClient creates a new kubernikus HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Kubernikus {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new kubernikus HTTP client,
...
// Kubernikus is a client for kubernikus
...
func (c *Kubernikus) SetTransport(transport runtime.ClientTransport) {
