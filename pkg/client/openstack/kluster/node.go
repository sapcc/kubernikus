...
func (n *Node) Stopping() bool {
	if n.TaskState == "spawning" || n.TaskState == "scheduling" || n.TaskState == "networking" || n.TaskState == "block_device_mapping" || n.TaskState == "image_uploading" || n.TaskState == "reboot_started" {
		return false
	}
