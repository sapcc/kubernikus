...
func Cordon(drainer *Helper, node *corev1.Node) error {
	return RunCordonOrUncordon(drainer, node, true)
}

func Uncordon(drainer *Helper, node *corev1.Node) error {
	return RunCordonOrUncordon(drainer, node, false)
}